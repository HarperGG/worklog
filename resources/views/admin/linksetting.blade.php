	...
	<table class="layui-table" lay-even lay-skin="line">
		...
		<tbody>
			<tr>
				...
				<td class="hidden-xs">
					<button class="layui-btn layui-btn-mini layui-btn-normal linksetting-edit-btn" data-id="1" data-url="{{url('admin/linksetting_add')}}"><i class="layui-icon">&#xe642;</i>修改</button>
