...
<head>
  ...
  <link type="text/css" href="lib/css/sample.css" rel="stylesheet" media="screen" />
...
<body>
  ...
  <script type="text/javascript" src="{{url('static/head/lib/js/ckeditor.js')}}"></script>
  <script>
    ClassicEditor
      .create(document.querySelector('#editor'), {
        ckfinder: {
          uploadUrl: 'http://chat.zerotsu.cn/picture/updatepicture',
        }
      })
      .catch(error => {
        console.error(error);
