...
<body>
	...
	<div id="header" class="header header-white">
		...
		<ul class="menu">
			<li class="item"><a class="item-hover" href="#">网站首页</a></li>
				...
				<li class="banner-menu-item ">
					...
					<div class="banner-menu-item-detail hide">
						<div class="light">
							...
							<div class="xian mrt30" style="margin-top: 30px;">
								<span>进阶</span>
							</div>
							<a>HTML5</a>
							<a>CSS3</a>
				...
				<div class="banner-img">
					<div class="swiper-wrapper">
						<div class="swiper-slide" data-swiper-autoplay="3000"
							style="background:url({{url('img/head/lunbo1.jpg')}}) no-repeat ;background-size: 936px 444px;"></div>
					</div>
					<!-- Add Pagination -->
	...
	<div class="newcourse">
		<div class="newcourse-wrap">
			...
			<div id="learnLink" class="shizhan-banner">
				...
				<a href="{{url('learnPathList')}}" class="lookMore">查看更多 ></a>
			</div>
